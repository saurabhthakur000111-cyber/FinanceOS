class DCFValuation:
    ...
    def __init__(self, free_cash_flow, growth_rate, discount_rate, terminal_growth):
    ...
    def calculate(self):
        ...
        terminal_value = (cashflow * (1 + self.terminal)) / (
...
if __name__ == "__main__":
    ...
    dcf = DCFValuation(
        free_cash_flow=100, growth_rate=0.10, discount_rate=0.12, terminal_growth=0.03
    )
